...
# Question 5 ==========================================================================================
print("Question 5:")
print("Using previous calculated buy-and-hold result: $125.70 after starting from $100. The model predicted"
	+ " the following weeks:")
print(model.predict(returns2))
print("Given this, it doesn't appear to predict any good trading weeks throughout year 2")
